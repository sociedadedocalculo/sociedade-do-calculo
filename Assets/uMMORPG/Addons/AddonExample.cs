...
public partial class Pet
{
    ...
    void LateUpdate_Example() {}
    void OnDestroy_Example() {}
    [Server] private void OnLevelUp_Example() {}
    [Server] private void DealDamageAt_Example(Entity entity, int amount) {}
    [Server] private void OnAggro_Example(Entity entity) {}
    [Server] private void OnDeath_Example() {}
}
